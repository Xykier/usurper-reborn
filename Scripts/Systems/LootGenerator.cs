...
public static class LootGenerator
    {
        ...
        private static readonly List<(string Name, string[] Classes, int MinLevel, int MaxLevel, float BasePower)> WeaponTemplates = new()
        {
            ...
            ("Broadsword", new[] { "Warrior", "Paladin", "Barbarian", "Assassin", "MysticShaman" }, 20, 70, 35),
            ("Bastard Sword", new[] { "Warrior", "Paladin", "Assassin", "MysticShaman" }, 35, 85, 55),
            ("Greatsword", new[] { "Warrior", "Barbarian" }, 50, 100, 80),
            ("Executioner's Blade", new[] { "Warrior" }, 70, 100, 110),

            // Axes - High damage, slower
            ("Hand Axe", new[] { "Warrior", "Barbarian", "Ranger", "MysticShaman" }, 1, 30, 12),
            ("Battle Axe", new[] { "Warrior", "Barbarian", "MysticShaman" }, 15, 60, 28),
            ...
            // Maces - Anti-armor
            ("Club", new[] { "All" }, 1, 20, 6),
            ("Mace", new[] { "Cleric", "Paladin", "Warrior", "Jester", "Alchemist", "MysticShaman" }, 10, 45, 18),
            ("War Hammer", new[] { "Cleric", "Paladin", "Warrior", "Alchemist", "MysticShaman" }, 25, 70, 40),
            ("Flail", new[] { "Cleric", "Paladin", "Alchemist", "MysticShaman" }, 40, 85, 60),
            ...
            ("Sledgehammer", new[] { "Warrior", "Barbarian", "Paladin", "MysticShaman" }, 5, 35, 14),
            ("War Maul", new[] { "Warrior", "Barbarian", "MysticShaman" }, 15, 55, 22),
            ("Crusher", new[] { "Warrior", "Barbarian", "MysticShaman" }, 30, 70, 32),
            ("Earthshaker", new[] { "Warrior", "Barbarian", "Paladin", "MysticShaman" }, 45, 85, 44),
            ("Skullbreaker", new[] { "Warrior", "Barbarian", "MysticShaman" }, 65, 100, 54),
        ...
        private static readonly List<(string Name, string[] Classes, int MinLevel, int MaxLevel, float BasePower)> ArmorTemplates = new()
        {
            ...
            ("Studded Leather", new[] { "Ranger", "Assassin", "Barbarian", "MysticShaman" }, 15, 50, 18),
            ("Hard Leather", new[] { "Ranger", "Assassin", "MysticShaman" }, 30, 70, 32),
            ...
            // Light fighter armor
            ("Training Gi", new[] { "Assassin", "Barbarian", "MysticShaman" }, 5, 35, 10),
            ("Reinforced Gi", new[] { "Assassin", "Barbarian", "MysticShaman" }, 25, 65, 28),
            ("Master's Gi", new[] { "Assassin", "Barbarian", "MysticShaman" }, 50, 90, 52),
            ("Dragon Scale Gi", new[] { "Assassin", "Barbarian", "MysticShaman" }, 80, 100, 88),

            // Chain (Medium classes)
            ("Chain Shirt", new[] { "Warrior", "Paladin", "Cleric", "Ranger", "MysticShaman" }, 10, 45, 15),
            ("Chain Mail", new[] { "Warrior", "Paladin", "Cleric", "MysticShaman" }, 25, 65, 30),
            ("Reinforced Chain", new[] { "Warrior", "Paladin", "Cleric", "MysticShaman" }, 45, 85, 52),

            // Plate (Heavy classes)
            ("Banded Mail", new[] { "Warrior", "Paladin", "MysticShaman" }, 20, 55, 25),
            ("Splint Mail", new[] { "Warrior", "Paladin", "MysticShaman" }, 35, 70, 40),
            ("Plate Mail", new[] { "Warrior", "Paladin" }, 50, 85, 60),
            ("Full Plate", new[] { "Warrior", "Paladin" }, 65, 95, 85),
            ("Adamantine Plate", new[] { "Warrior" }, 85, 100, 120),

            // Paladin holy armor
            ("Holy Vestments", new[] { "Paladin", "Cleric", "MysticShaman" }, 30, 70, 38),
        ...
        private static readonly List<(string Name, string[] Classes, int MinLevel, int MaxLevel, float BasePower)> HeadArmorTemplates = new()
        {
            ...
            ("Chain Coif", new[] { "Warrior", "Paladin", "Cleric", "Ranger", "MysticShaman" }, 15, 55, 16),
            ("Reinforced Helm", new[] { "All" }, 20, 50, 14),
            ("Steel Helm", new[] { "Warrior", "Paladin", "Barbarian" }, 25, 65, 25),
            ("Wizard's Hat", new[] { "Magician", "Sage" }, 15, 60, 10),
            ("Fighter's Headband", new[] { "Assassin", "Barbarian", "Ranger", "MysticShaman" }, 10, 55, 8),
            ("Shadow Hood", new[] { "Assassin", "Ranger", "MysticShaman" }, 20, 70, 18),
        ...
        private static readonly List<(string Name, string[] Classes, int MinLevel, int MaxLevel, float BasePower)> ArmsArmorTemplates = new()
        {
            ...
            ("Iron Vambraces", new[] { "Warrior", "Paladin", "Barbarian", "MysticShaman" }, 10, 45, 10),
            ("Chain Sleeves", new[] { "Warrior", "Paladin", "Cleric", "MysticShaman" }, 15, 55, 14),
            ("Studded Armguards", new[] { "Ranger", "Assassin", "MysticShaman" }, 15, 50, 12),
            ("Reinforced Bracers", new[] { "All" }, 20, 50, 12),
            ("Steel Vambraces", new[] { "Warrior", "Paladin", "MysticShaman" }, 25, 65, 22),
        ...
        private static readonly List<(string Name, string[] Classes, int MinLevel, int MaxLevel, float BasePower)> HandsArmorTemplates = new()
        {
            ...
            ("Chain Gauntlets", new[] { "Warrior", "Paladin", "Cleric", "MysticShaman" }, 15, 55, 14),
            ("Thief's Gloves", new[] { "Assassin", "Ranger", "MysticShaman" }, 10, 50, 10),
            ...
            ("Spiked Fists", new[] { "Barbarian", "Warrior", "MysticShaman" }, 30, 70, 25),
        ...
        private static readonly List<(string Name, string[] Classes, int MinLevel, int MaxLevel, float BasePower)> LegsArmorTemplates = new()
        {
            ...
            ("Chain Leggings", new[] { "Warrior", "Paladin", "Cleric", "Ranger", "MysticShaman" }, 15, 55, 15),
            ("Studded Legguards", new[] { "Ranger", "Assassin", "MysticShaman" }, 15, 50, 12),
            ("Iron Greaves", new[] { "Warrior", "Paladin", "Barbarian", "MysticShaman" }, 20, 60, 20),
        ...
        private static readonly List<(string Name, string[] Classes, int MinLevel, int MaxLevel, float BasePower)> FeetArmorTemplates = new()
        {
            ...
            ("Scout's Boots", new[] { "Ranger", "Assassin", "MysticShaman" }, 10, 50, 9),
            ("Reinforced Boots", new[] { "All" }, 20, 50, 10),
            ("Chain Boots", new[] { "Warrior", "Paladin", "Cleric", "MysticShaman" }, 20, 60, 16),
            ...
            ("Traveler's Sandals", new[] { "Assassin", "Ranger", "MysticShaman" }, 20, 70, 15),
        ...
        private static readonly List<(string Name, string[] Classes, int MinLevel, int MaxLevel, float BasePower)> WaistArmorTemplates = new()
        {
            ...
            ("Chain Belt", new[] { "Warrior", "Paladin", "Cleric", "MysticShaman" }, 15, 50, 10),
            ("Sash of Focus", new[] { "Magician", "Sage", "Assassin" }, 10, 50, 7),
            ("Reinforced Belt", new[] { "All" }, 20, 50, 10),
            ("War Belt", new[] { "Warrior", "Barbarian", "MysticShaman" }, 20, 60, 15),
            ("Thief's Girdle", new[] { "Assassin", "Ranger", "MysticShaman" }, 15, 55, 11),
            ("Forged Girdle", new[] { "All" }, 35, 70, 22),
            ("Steel Girdle", new[] { "Warrior", "Paladin", "MysticShaman" }, 35, 75, 25),
            ("Mithril Belt", new[] { "All" }, 50, 85, 38),
            ("Runed Belt", new[] { "All" }, 65, 100, 50),
            ("Holy Sash", new[] { "Paladin", "Cleric", "MysticShaman" }, 40, 80, 30),
        ...
        private static readonly List<(string Name, string[] Classes, int MinLevel, int MaxLevel, float BasePower)> FaceArmorTemplates = new()
        {
            ...
            ("Iron Visor", new[] { "Warrior", "Paladin", "Barbarian", "MysticShaman" }, 15, 55, 12),
            ("Shadow Mask", new[] { "Assassin" }, 15, 60, 10),
            ("War Mask", new[] { "Warrior", "Barbarian", "MysticShaman" }, 25, 65, 18),
            ("Mystic Veil", new[] { "Magician", "Sage", "Cleric" }, 20, 65, 12),
            ("Forged Visor", new[] { "All" }, 35, 70, 24),
            ("Steel Faceplate", new[] { "Warrior", "Paladin", "MysticShaman" }, 40, 80, 30),
        ...
        private static readonly List<(string Name, string[] Classes, int MinLevel, int MaxLevel, float BasePower)> ShieldTemplates = new()
        {
            ...
            ("Duelist's Buckler", new[] { "Warrior", "Paladin", "Ranger", "Assassin", "MysticShaman" }, 30, 70, 22),
            ("Forged Buckler", new[] { "All" }, 35, 70, 28),
            ("Elven Buckler", new[] { "All" }, 50, 85, 38),
            ("Runed Buckler", new[] { "All" }, 65, 100, 50),
            ("Phantom Buckler", new[] { "Assassin", "Ranger", "MysticShaman" }, 70, 100, 55),

            // Standard Shields (balanced protection)
            ("Leather Shield", new[] { "All" }, 1, 25, 5),
            ("Wooden Shield", new[] { "All" }, 5, 30, 7),
            ("Iron Shield", new[] { "Warrior", "Paladin", "Cleric", "Barbarian", "MysticShaman" }, 10, 40, 11),
            ("Steel Shield", new[] { "Warrior", "Paladin", "Cleric", "Barbarian", "MysticShaman" }, 20, 55, 18),
            ("Knight's Shield", new[] { "Warrior", "Paladin", "MysticShaman" }, 30, 65, 25),
            ("Heater Shield", new[] { "Warrior", "Paladin", "Cleric", "MysticShaman" }, 40, 75, 32),
            ("Paladin's Shield", new[] { "Paladin", "Cleric", "MysticShaman" }, 50, 85, 40),
            ("Dragon Scale Shield", new[] { "Warrior", "Paladin", "MysticShaman" }, 60, 95, 52),
            ("Aegis", new[] { "Warrior", "Paladin", "MysticShaman" }, 75, 100, 65),
